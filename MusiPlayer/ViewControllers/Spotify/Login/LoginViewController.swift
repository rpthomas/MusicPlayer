...
func setup()
{
    spotifyLoginBtn.layer.masksToBounds = false
    spotifyLoginBtn.layer.cornerRadius = 5
    spotifyLoginBtn.layer.shadowColor = UIColor.black.cgColor
    spotifyLoginBtn.layer.shadowOffset = CGSize(width: 5.0, height: 10.0)
    spotifyLoginBtn.layer.shadowOpacity = 0.5
    spotifyLoginBtn.layer.shadowRadius = 5
    spotifyLoginBtn.layer.borderColor = UIColor.black.cgColor
    spotifyLoginBtn.layer.borderWidth = 1
}
...
extension LoginViewController: WKNavigationDelegate {
    ...
    func RequestForCallbackURL(request: URLRequest) {
        ...
        //if requestURLString.contains(SpotifyConstants.REDIRECT_URI) {
